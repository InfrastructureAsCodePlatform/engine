...
from harakiri.boilerplates.configs import SUBTYPE_CHOICES, TYPE_CHOICES
...
class Boilerplate(BaseModel):
    ...
    docker_image = models.CharField("Docker Image", max_length=64, null=False, blank=False)
    docker_command = models.CharField("Docker Command", max_length=64, null=False, blank=False)
    docker_directory = models.CharField("Docker Directory", max_length=32, null=False, blank=False)
